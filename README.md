...
https://dev.axiomide.com/marketplace/christiangeorgelucas/html-markdown-tools@0.1.0
...
```bash
axiom invoke christiangeorgelucas/html-markdown-tools/ConvertToMarkdown --input '{ ... }'
```

**Call it over HTTP.**

```bash
curl -X POST https://api.axiomide.com/invocations/v1/nodes/christiangeorgelucas/html-markdown-tools/0.1.0/ConvertToMarkdown \
...
> `axiom inspect node christiangeorgelucas/html-markdown-tools/ConvertToMarkdown`.
