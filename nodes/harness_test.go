...
// keep it in this one file only (axiom create node scaffolds a fresh copy
// per node file; the duplicates were deleted here to avoid a redeclaration).
...
// testFlowMutation is a no-op mutation sink — none of this package's nodes are mutation-capable.
